"""
Django settings for displayboardapi project.
...
SECRET_KEY = 'django-insecure-3yvy(!*h**r0bl$9^q_l(y4lmo6fcy=jx@)##kl6#f^!kz-s7i'
...
WSGI_APPLICATION = 'displayboardapi.wsgi.application'
